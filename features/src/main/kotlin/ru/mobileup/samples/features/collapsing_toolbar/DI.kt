...
import ru.mobileup.samples.features.collapsing_toolbar.presentation.advanced.RealCollapsingToolbarAdvancedComponent
...
fun ComponentFactory.createCollapsingToolbarAdvancedComponent(
    componentContext: ComponentContext
): CollapsingToolbarAdvancedComponent = RealCollapsingToolbarAdvancedComponent(componentContext)
