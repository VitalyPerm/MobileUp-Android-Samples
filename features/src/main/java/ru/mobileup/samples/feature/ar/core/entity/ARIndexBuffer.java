 ...
 *
 * <p>When constructing a {@link ARMesh}, an {@link ARIndexBuffer} may be passed to describe the
 ...
 */
public class ARIndexBuffer implements Closeable {
  private final ARGpuBuffer buffer;

  /**
   * Construct an {@link ARIndexBuffer} populated with initial data.
   *
   ...
   * instead.
   */
  public ARIndexBuffer(ARSampleRender render, IntBuffer entries) {
    buffer = new ARGpuBuffer(GLES30.GL_ELEMENT_ARRAY_BUFFER, ARGpuBuffer.INT_SIZE, entries);
  }
